	...
	public Map<String, Object> getConfig ( int type ) {
		...
		switch ( type ) {
			...
			case ActionMap.LIST_IMAGE:
				...
				conf.put( "dir", this.jsonConfig.getString( "imageManagerListPath" ).replaceAll("%SHOP_ID%" , String.valueOf(WebUtil.getShopId())) );
				conf.put( "count", this.jsonConfig.getIntValue( "imageManagerListSize" ) );
				break;

			case ActionMap.LIST_FILE:
				conf.put( "allowFiles", this.getArray( "fileManagerAllowFiles" ) );
				conf.put( "dir", this.jsonConfig.getString( "fileManagerListPath" ).replaceAll("%SHOP_ID%" , String.valueOf(WebUtil.getShopId())) );
