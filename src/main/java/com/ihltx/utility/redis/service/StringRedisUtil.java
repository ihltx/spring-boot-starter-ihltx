...
public interface StringRedisUtil {

	/**
	 * 获取当前 StringRedisTemplate 对象
	 * @return
	 */
	StringRedisTemplate getCurrStringRedisTemplate();

	/**
	 * 修改当前 StringRedisTemplate 对象
	 * @param currStringRedisTemplate
	 */
	void setCurrStringRedisTemplate(StringRedisTemplate currStringRedisTemplate);
